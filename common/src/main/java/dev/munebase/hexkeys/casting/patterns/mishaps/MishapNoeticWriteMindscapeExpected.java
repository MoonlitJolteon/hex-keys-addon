...
public class MishapNoeticWriteMindscapeExpected extends Mishap {
    private final BlockPos pos;

    public MishapNoeticWriteMindscapeExpected(BlockPos pos) {
        this.pos = pos;
    }
    ...
    public Text errorMessage(@NotNull CastingEnvironment castingContext, @NotNull Mishap.Context context) {
        return this.error("noetic_write_mindscape_expected");
    }
