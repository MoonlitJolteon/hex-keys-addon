...
public class MishapNoeticCompatibleBookshelfExpected extends Mishap
{
	private final BlockPos pos;

	public MishapNoeticCompatibleBookshelfExpected(BlockPos pos) {
		this.pos = pos;
	}
	...
	{
		return this.error("noetic_or_akashic_bookshelf_expected");
	}
