...
public class HexkeysPatternRegistry {
    ...
    public static HexPattern WRITE_NOETIC_BOOKSHELF = register(HexPattern.fromAngles("eeeqqq", HexDir.SOUTH_EAST), "write_noetic_bookshelf", OpWriteNoeticBookshelf.INSTANCE);
